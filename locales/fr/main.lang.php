...
L10n::$locales['Module "%s" is not well configured.']                                   = 'Le module "%s" est mal configuré';
L10n::$locales['Plugins root']                                                          = 'Racine des plugins';
L10n::$locales['Themes root']                                                           = 'Racine des thèmes';
L10n::$locales['Themes packages repository']                                            = 'Dépôt de paquetages de thèmes';
L10n::$locales['Plugins packages repository']                                           = 'Dépôt de paquetages de plugins';
...
L10n::$locales['Select non lastest versions']                                           = 'Sélectionner les versions anciennes';
